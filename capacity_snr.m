...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
rho_store = rho_store * 1e-7;%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
h = figure;
set(h,'PaperType','A4');
axes('FontSize',16);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
plot(10 * log10(rho_store), capacity(1:length(rho_store), 1), 'k--s','LineWidth',2,'MarkerSize',10)
hold on
plot(10 * log10(rho_store), capacity(1:length(rho_store), 2), 'k--*','LineWidth',2,'MarkerSize',10)
plot(10 * log10(rho_store), capacity(1:length(rho_store), 3), 'k--o','LineWidth',2,'MarkerSize',12)
plot(10 * log10(rho_store), capacity(1:length(rho_store), 4), 'k-^','LineWidth',2,'MarkerSize',10)
...
% plot(10 * log10(rho_store), capacity(1:length(rho_store), 4), 'k-^','LineWidth',2,'MarkerSize',10)
% xlim([min(10 * log10(rho_store)), max(10 * log10(rho_store))])
% le = legend('几何规划','逐次凸近似','本发明方法', 'Location', 'northwest');
% set(le,'Fontsize',16,'Fontname','Times')
% set(gca,'XTick',10 * log10(rho_store))
% xlabel('信噪比 (dB)','Fontsize',20,'Fontname','Times')
% ylabel('频谱效率 (bps/Hz)','Fontsize',20,'Fontname','Times')
% grid on
